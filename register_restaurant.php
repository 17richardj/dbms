...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["r_name"]))){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            // Set parameters
            $param_username = trim($_POST["r_name"]);
...
<body>
  <nav id = "navbarColo" class="navbar navbar-expand-lg navbar-light  navbar-fixed">
    ...
    <div class="container h-100 col-sm-8" style="margin-top: 3%">
      <h2 style="font-family: garamond">Register Restaraunt</h2>
      <hr>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="form1" method="post" class="needs-validation h-100" oninput='r_confirm_password.setCustomValidity(r_password.value != r_confirm_password.value ? "Passwords do not match." : "")'>
          <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
            <label for="email">Name:</label>
            <input type="text" class="form-control" id="uname" minLength="4" maxlength="20" placeholder="Enter username"  value="<?php echo $username; ?>" name="r_name"  value="<?php echo $username; ?>" required>
  ...
  <div class="col">
          <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
            ...
            <input type="password" class="form-control" id="pwd" minLength="8" placeholder="Enter password" value="<?php echo $password; ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" name="r_password" required>
        ...
        <div class="col">
                <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                  ...
                  <input type="password" class="form-control" id="pwd" minLength="8" placeholder="Confirm Password" value="<?php echo $confirm_password; ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" name="r_confirm_password" required>
