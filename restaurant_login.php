...
<div class="container h-100 col-sm-8" style="margin-top: 3%">
  <h2 style="font-family: garamond">Restaurant Login</h2>
	<hr>
    <form id="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="needs-validation">
      <div class="form-group">
        <label for="email">Name:</label>
        <input type="text" class="form-control" id="uname" placeholder="Enter username" name="r_name" value="<?php echo $username; ?>" required>
        <div class="valid-feedback">Valid.</div>
        <div class="invalid-feedback">Please fill out this field.</div>
      </div>
      <div class="form-group">
        <label for="password">Password:</label>
        <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="r_password" required>
        <div class="valid-feedback">Valid.</div>
        <div class="invalid-feedback">Please fill out this field.</div>
      </div>
    ...
    <div class="footer-copyright text-center py-3">
      ...
      <div class="footer-copyright text-center py-3">Don't Have an Account?
        <a href="/dbms/register_restaurant.php" style="color: black"> <strong>click here</strong></a>
      </div>
    </div>
    </div>
    </form>
